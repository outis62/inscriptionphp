...
?> <div class="container">
    <div class="row">
 <div class="col-md-3"><form method="post" action="supprimer.php">
          <input type="hidden" name="supprimer_id" value="<?php echo $etudiant['id']; ?>">
