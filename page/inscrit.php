...
<body>
  ...
  while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    <a href='modifier.php?id=" . $row['id'] . "' class='btn btn-primary' onclick='return confirm(\"Voulez-vous vraiment modifier cet apprenant ?\")'>Modifier</a></td>";
    echo "</tr>";
...
<!-- 
 ...
 <!-- 
  if (isset($_GET['id'])) {
      ...
      $stmt->bindParam(':delete', $dlete, PDO::PARAM_INT);
      if ($stmt->execute()) {
