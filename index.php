...
<head>
    ...
    <link rel="stylesheet" href="style/authent.css">
    <link rel="shortcut icon" href="images/ufrsds.jpg">
    <title>UFR/SDS/Authentification/Page</title>
</head>
...
<body>
    ...
    <header>
        ...
        <div class="header">
            ...
            <div class="inner-header flex">
                <!--Just the logo.. Don't mind this-->
                    <img src="images/ufrsds.jpg" class="rounded mb-1 me-2" width="50" height="50" alt="" />
                    <h1 class="fw-bold">StudentHub</h1>
                    <?php
                        session_start();
                        if (isset($_SESSION['inscrit'])) {
        
                            echo "<p>Vous êtes inscrit. Connectez-vous avec vos identifiants.</p>";
                        } else {
        
                            echo '<a href="page/admininscription.php" class="btn btn-success">Inscription</a>';
                            }
                    ?>
            ...
            <div>
                <svg class="waves" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <g class="parallax">
                        <use xlink:href="#gentle-wave" x="48" y="0" fill="rgba(229,22,22,0.7" />
                        <use xlink:href="#gentle-wave" x="48" y="3" fill="rgba(194,130,27,0.5)" />
                        <use xlink:href="#gentle-wave" x="48" y="5" fill="rgba(47,184,16,0.3)" />
        ...
        <div class="content flex">
            <p class="fw-bold fs-3">UFR-SDS </p>
        </div>
        <!--Content ends-->
    </header>
    <div class="container mb-5">
        <div class="left">
            <form class="form" method="get">
                <div class="input-block">
                    <input class="input" type="text" name="usernam" id="username" required="">
                    <label for="username">Username</label>
                </div>
                <div class="input-block">
                    <input class="input" type="password" name="passworde" id="password" required="">
                    <label for="pass">Password</label>
                </div>
                <div class="input-block">
                    <span class="forgot"><a href="#">Mot de passe oublie?</a></span>
        ...
        <div class="right">
           ...
           <?php
            include('page/authentification1.php');
           ?>
        </div>
    </div>
